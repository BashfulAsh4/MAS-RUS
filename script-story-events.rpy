...
Я вижу, что ты делаешь Монику очень счастливой, и я хочу помочь, чем могу!
Я добавил новую колоду карт, которую ты можешь отдать Монике. Я уверен, что вы оба сможете разобраться, как играть в эту игру.

Чтобы подарить её, создайте новый файл 'noudeck.gift' в папке 'characters'.
